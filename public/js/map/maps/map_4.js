...
export default {
  ...
  materials: [
...

    {
      ...MAP_MATERIALS.tile,
      position: GRID[0][0],
      backgroundPosition: TILES.reversed.black[0][0],
    },
    {
      ...MAP_MATERIALS.tile,
      position: GRID[2][0],
    ...
    },
    {
      ...MAP_MATERIALS.tile,
      position: GRID[2][14],
      backgroundPosition: TILES.floating.black[1],
    },
    {
      ...MAP_MATERIALS.tile,
      position: GRID[4][14],
    ...
    },
    {
      ...MAP_MATERIALS.tile,
      position: GRID[6][14],
      backgroundPosition: TILES.floating.black[2],
    },
    {
      ...MAP_MATERIALS.tile,
      position: GRID[8][14],
    ...
    },
    {
      ...MAP_MATERIALS.tile,
      position: GRID[42][14],
      backgroundPosition: TILES.floating.black[0],
    },
    {
      ...MAP_MATERIALS.tile,
      position: GRID[44][14],
  ...
  miscs: [
    {
      id: 'trigger-1',
      name: MISCS.button,
      position: { x: GRID[4][13].x, y: GRID[4][13].y + 7.77 },
    },
    {
      id: 'trigger-2',
      name: MISCS.lever,
